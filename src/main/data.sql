...
INSERT INTO authors (first_name, last_name, email,dob ,about) VALUES ( 'Eric','Cartman','eric@gmail.com','1997-01-01','coon');
...
INSERT INTO books (copies, field, pages, ref_code, title, year_of_publication, isbn, author_id,publisher_id) VALUES (5,'food',100,'e180','the best chilly',2020,'laorjt12885',1,1);
INSERT INTO books (copies, field, pages, ref_code, title, year_of_publication, isbn, author_id,publisher_id) VALUES (1000,'physics',100,'ey180','on multiple universes',2020,'laorjt125',4,2);
